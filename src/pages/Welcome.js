  ...
  useEffect(() => {
    if (!hasSpokenWelcome) {
      // Wait for voices to be available
        ...
        const message = new SpeechSynthesisUtterance("Welcome to i cart master. To navigate to the user login page, please click the microphone and say 'go to user login'.");
